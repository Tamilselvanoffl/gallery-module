...
const uri = "mongodb+srv://tamil:Tamil123@cluster0.dggqilm.mongodb.net/galleryDB?retryWrites=true&w=majority";
mongoose.connect(uri)
  .then(() => console.log("connected"))
  .catch((e) => console.error(e));declare module 'mongoose' {
